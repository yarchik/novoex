...
var _slider = _interopRequireDefault(require("./temp-modules/slider"));
var _choose = _interopRequireDefault(require("./temp-modules/choose"));
var _burgerMenu = _interopRequireDefault(require("./temp-modules/burger-menu"));
...
(function ($) {
  ...
  $(function () {
    ...
    _choose["default"].init();
    _burgerMenu["default"].init();
  });
})(jQuery);

},{"./temp-modules/burger-menu":93,"./temp-modules/choose":94,"./temp-modules/slider":95}],93:[function(require,module,exports){
"use strict";
...
exports["default"] = void 0;
var choose = function () {
  var chooseFunc = function chooseFunc() {
...
var _default = exports["default"] = choose;
...
var swiperSlider = function () {
  var heroSlider = new Swiper('.hero-section-slider', {
    slidesPerView: 1,
    spaceBetween: 20,
    speed: 800,
  ...
  var insightsSlider = new Swiper('.insights-section-slider', {
    slidesPerView: 1,
    speed: 800,
    loop: true,
    centeredSlides: true,
